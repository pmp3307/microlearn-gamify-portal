              ...
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-4">
                  <Avatar className="h-20 w-20">
                    <AvatarImage src="" />
                    <AvatarFallback className="bg-elearn-blue text-white text-xl">JD</AvatarFallback>
                  </Avatar>
                  <div>
                ...
                <div className="grid gap-4 py-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="bio" defaultValue="Team Lead - Learning path for front-end development" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <button className="w-8 h-8 rounded-full bg-elearn-blue border-2 border-elearn-blue"></button>
                      ...
                      <button className="w-8 h-8 rounded-full bg-amber-500 border-2 border-transparent"></button>
